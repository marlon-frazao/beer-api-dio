...
import static com.marlon.beerapi.utils.JsonConvertionUtils.asJsonString;
...
import com.marlon.beerapi.factory.BeerFactory;
import com.marlon.beerapi.factory.QuantityDTOFactory;
...
public class BeerControllerTest {
	...
	void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
		// given
		BeerDTO beerDTO = BeerFactory.createBeerDTO(1L);

		// when
		when(beerService.create(any())).thenReturn(beerDTO);
	...
	void whenDELETEIsCalledWithInvalidIdThenNotFoundStatusIsReturned() throws Exception {
		...
		// then
		mockMvc.perform(MockMvcRequestBuilders.delete(BEER_API_URL_PATH + "/{id}", INVALID_BEER_ID)
				.contentType(MediaType.APPLICATION_JSON)).andExpect(status().isNotFound());
	}

	@Test
	void whenPATCHIsCalledToIncrementDiscountThenOKstatusIsReturned() throws Exception {
		QuantityDTO quantityDTO = QuantityDTOFactory.createQuantityDTO(10);
